                        ...
                        <div className="card p-6 space-y-4">
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        className={`input w-full py-2.5 px-3 text-sm rounded-lg focus:outline-none focus:ring-0 focus:ring-[var(--app-primary)] focus:border-[var(--app-primary)] shadow-sm ${frontendErrors.title &&
                                            'border-red-500'
                                            }`}
                                ...
                                <div>
                                    ...
                                    <input
                                        className={`input w-full py-2.5 px-3 text-sm rounded-lg focus:outline-none focus:ring-0 focus:ring-[var(--app-primary)] focus:border-[var(--app-primary)] shadow-sm ${frontendErrors.offer_code &&
                                            'border-red-500'
                                            }`}
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        type="number"
                                        className={`input w-full py-2.5 px-3 text-sm rounded-lg focus:outline-none focus:ring-0 focus:ring-[var(--app-primary)] focus:border-[var(--app-primary)] shadow-sm ${frontendErrors.price &&
                                            'border-red-500'
                                            }`}
                                ...
                                <div>
                                    ...
                                    <Select
                                        ...
                                        value={
                                            form.data.duration_days
                                                ? {
                                                    value: Number(form.data.duration_days),
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="label">رقم واتساب (اختياري)</label>
                                    <input
                                        className="input w-full py-2.5 px-3 text-sm rounded-lg focus:outline-none focus:ring-0 focus:ring-[var(--app-primary)] focus:border-[var(--app-primary)] shadow-sm"
                                    ...
                                    value={{
                                        ...
                                        label:
                                            form.data.tour_level === 'vip'
                                                ? 'VIP'
                                                : form.data.tour_level === 'standard'
                                                    ? 'عادي'
                                                    : form.data.tour_level === 'economical'
                                                        ? 'اقتصادي' : form.data.tour_level === 'luxury' ? 'فاخر' : '',
                                    }}
                                    onChange={opt =>
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <InputError message={frontendErrors.governorates} />
                ...
                px-2 py-1 rounded-full text-xs flex items-center gap-1"
                        ...
                        <div className="card p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    className={`input w-full py-2.5 px-3 text-sm rounded-lg focus:outline-none focus:ring-0 focus:ring-[var(--app-primary)] focus:border-[var(--app-primary)] shadow-sm ${frontendErrors.seo_title &&
                                        'border-red-500'
                                        }`}
                            ...
                            <div>
                                ...
                                <textarea
                                    rows={4}
                                    className={`input w-full py-2.5 px-3 text-sm rounded-lg focus:outline-none focus:ring-0 focus:ring-[var(--app-primary)] focus:border-[var(--app-primary)] shadow-sm ${frontendErrors.seo_description &&
                                        'border-red-500'
                                        }`}
                                    ...
                                    {previewImages.map((src, index) => (
                                        ...
                                        >
                                            ...
                                            <button
                                                type="button"
                                                onClick={() =>
                                                    form.setData('is_main_image', index)
                                                }
                                                className={`absolute top-1 left-1 p-1 rounded-full ${form.data.is_main_image === index
