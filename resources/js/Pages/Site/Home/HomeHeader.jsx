    ...
    return (
        <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b shadow-sm">
            <div className="relative flex items-center justify-between px-6 lg:px-40 py-4">
                ...
                <div className="hidden lg:flex items-center flex-1 gap-6 justify-end">
                    <div
                        ...
                        className="flex-1 max-w-md mr-9 relative"
                    >
                        <input
                            type="text"
                            ...
                            onFocus={() =>
                                searchResults.length && setDropdownOpen(true)
                            }
                        />
                    ...
                    <nav className="flex gap-12 text-sm font-medium text-gray-700 mr-9 items-center">
                        <NavLink href="/">الرئيسية</NavLink>
                        <NavLink href="/packages">الباقات</NavLink>
                        <NavLink href="/about">من نحن</NavLink>
                        <div className="px-4 py-2 bg-[var(--app-primary)] text-white rounded-xl shadow-sm btn-primary ">
            ...
            >
                ...
                />
                <div
                    className={`absolute top-0 left-0 right-0 bg-white rounded-b-3xl shadow-xl transition-transform duration-300 ${menuOpen ? "translate-y-0" : "-translate-y-full"}`}
                >
